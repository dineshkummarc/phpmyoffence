					...
					<div style = "width:40%; margin-left:32%;">	
						<form method = "POST" action = "add_stations.php">	
							<div class = "form-group">
								<label>city</label>
								<input type = "text" class = "form-control" name = "location"  onKeyup ="namesOnly(this)" required = "required"/>
							</div>
							
							<div class = "form-group">
								<label>Area/branch</label>
								<input type = "text" min="#" class = "form-control" name = "branch" onKeyup ="charactersOnly(this)" required = "required"/>
							</div>
							<br />
							<div class = "form-group">
