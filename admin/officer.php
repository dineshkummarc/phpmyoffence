				...
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `officer_user`") or die(mysqli_error());
								...
								<tr>
									...
									<td><?php echo $a_fetch['surname']?></td>
									<td><center><a href = "edit_officer.php?officer_id=<?php echo $a_fetch['officer_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" name = "<?php echo $a_fetch['officer_id']?>" data-toggle = "modal" data-target = "#delete_officer" class = "btn btn-danger admin_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
								</tr>
								<?php
									}
								?>
