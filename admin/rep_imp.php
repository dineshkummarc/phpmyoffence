...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
			<div class = "alert alert-info">List of impunded vehicle </div>
			<div>
	   <form method="POST">
						...
						<tbody>
							<?php
				                ...
				                //MySQLi Object-oriented
				                        $oquery=$conn->query("select o.license_id,o.vehicle_color ,d.firstname,d.lastname,d.class,d.gender,o.regnumber,o.date_in from impounding o,drivers d WHERE o.license_id =d.license_id AND o.date_in between '$from' and '$to'");
					                ...
					                <tr>
						              ...
						              <td><?php echo $orow['vehicle_color']?></td>
						              <td><?php echo $orow['date_in']?></td>
						              <!-- <td><?php echo $orow['model']?></td>
						              <td><?php echo $orow['year_man']?></td>
							...
							<?php
			                    if (isset($_POST['submit'])){
				                  include('../connect.php');
				                       ...
				                       $to=date('Y-m-d',strtotime($_POST['to']));
				                //MySQLi Object-oriented
				                         $oquery=$conn->query("select o.license_id,d.firstname,d.lastname,d.class,d.gender,o.offense_committed,o.chi_date from impounding o,drivers d WHERE o.license_id =d.license_id AND o.chi_date between '$from' and '$to'");
				                    while($orow = $oquery->fetch_array()){
					                ?>
					                <tr>
						              <td><?php echo $orow['license_id']?></td>
