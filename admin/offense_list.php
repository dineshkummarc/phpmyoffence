					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><center><a href = "edit_offense.php?id=<?php echo $act_fetch['offense_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> </center></td>
							</tr>
							<?php
								}
							?>
					...
					<div style = "width:40%; margin-left:32%;">	
						<form method = "POST" action = "add_offense.php">	
							<div class = "form-group">
								...
								<input type = "text" class = "form-control" name = "offense_name" onKeyup ="character1Only(this)"  required = "required"/>
							</div>
							
							<div class = "form-group">
										<label>Gender</label>
										<select class = "form-control" name = "offense_points" required >
